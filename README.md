...
This is a list of sport analytics conferences, with a primary focus on hockey analytics. The goal of this list is to highlight events that bring together researchers, analysts, practitioners, and industry professionals who are interested in data-driven approaches to understanding and improving performance in sports.

## 🌍 Europe

- [Field Of Play](https://www.fieldofplay.co.uk/)
  - Date: March 27, 2026
  - Location: Manchester, UK
  - Sport: Football/Soccer
  - Note: The organizers mentioned that they are planning to include talks from other sports as well.
- **[Linköping Hockey Analytics Conference](https://www.ida.liu.se/research/sportsanalytics/LINHAC/)**
  - Date: June 2-4, 2026
...
- [New England Symposium on Statistics in Sports](https://www.nessis.org/)
  ...
  - Location: Boston, USA
  - Sport: Multiple
  - Note: Organized in odd-numbered years, alternates with Cascadia Symposium on Statistics in Sports.
- [Cascadia Symposium on Statistics in Sports](http://www.cascadiasports.com/)
  - Date: ?
